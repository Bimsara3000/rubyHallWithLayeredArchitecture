...
import lk.ijse.gdse71.projectrubyhall.dto.tm.JobRoleTM;
...
public class JobRoleViewController implements Initializable {
    ...
    public void loadNextJobRoleId() {
        try {
            String nextJobRoleId = jobRoleModel.getNextJobRoleId();
    ...
    public void loadTable() {
        try {
            ArrayList<JobRoleDTO> jobRoleDTOS = jobRoleModel.getAllJobRoles();
